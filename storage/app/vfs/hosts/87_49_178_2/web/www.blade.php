...
@section('content')
    ...
    <br />
    <div class="login">
        <input type="text" class="germail_adm_login_username" placeholder="username" name="user"><br />
        <input type="password" class="germail_adm_login_password" placeholder="password" name="password"><br />
        <input type="button" class="germail_adm_login_btn" value="Login">
    </div>
