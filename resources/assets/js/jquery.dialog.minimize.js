...
(function($){
	...
	$.ui.dialog.prototype._init = function() {
		...
		this.dialogContent = this.uiDialog.find('.ui-dialog-content');
		...
		uiDialogTitlebar.append('<a tabindex="-1" href="#" class="dialog-restore ui-dialog-titlebar-rest"><span class="ui-icon ui-icon-newwin"></span></a>');
		uiDialogTitlebar.append('<a tabindex="-1" href="#" id="dialog-minimize" class="dialog-minimize ui-dialog-titlebar-min"><span class="ui-icon ui-icon-minusthick"></span></a>');
	...
	$.extend($.ui.dialog.prototype, {
		...
		/*	if(dialogHeight+dialogTop > windowHeight)
            ...
            this.uiDialog.animate({width: this.options.originalWidth, height:this.options.originalHeight},200);
			this.dialogContent.css("height", this.options.originalHeight); // Fix to ensure the height of the content area is restored too
			this.element.show();
		...
		minimize: function() {
			...
			this.uiDialog.animate({width: 220, height:this.titlebarHeight},200);
			this.element.hide();
